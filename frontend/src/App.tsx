...
import { evaluateAnswer, type EvaluateRequest, type EvaluateResponse } from "./services/api";
import { GraduationCap, Layers, ArrowDown } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        ...
        >
          Score descriptive answers intelligently using state-of-the-art transformer models and hybrid semantic analysis.
        </motion.p>
      </div>
...
export default function App() {
  ...
  async function handleEvaluate(req: EvaluateRequest) {
    setLoading(true);
    setError("");
    setResult(null);
    try {
        ...
        <div ref={formRef}>
          ...
          >
            <div className="flex items-center gap-3 mb-7">
              ...
              <div>
                <h2 className="font-bold text-white text-base">Evaluate an Answer</h2>
                <p className="text-xs text-slate-500">Paste the question, model answer, and student answer below</p>
              </div>
            </div>
